...
export default function ProductDetails() {
  ...
  return (
    <>
      <motion.button className="w-10 h-10 mt-4 ml-4" initial={{
            y: -700,
            opacity:0,
          }}
          animate={{
      ...
      <div className="flex justify-center flex-col items-center">
        ...
        <motion.h1 className="text-4xl py-6 font-bold" initial={{
              x: 100,
              scale: 1,
              opacity:0,
            }}
        ...
        transition={{ duration: .9 }} >Product Details</motion.h1>

        <motion.div className="bg-white rounded-lg p-4 mb-4 mt-11"   initial={{
              x: -200,
              scale: 1,
              opacity:0,
            }}
